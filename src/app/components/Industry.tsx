...
const IndustryPage = () => {
  ...
  <div className="relative w-80 h-80">
    ...
    <div className="w-full h-full flex items-center justify-center px-8 py-6 border-l-2 border-opacity-60 transition-all duration-300 mx-auto md:mx-0 blur-none hover:blur-sm bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-500/50 z-0">
